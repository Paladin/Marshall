(function(){
	...
	describe("Game", function() {
		describe("Producing Forsythe Notation in move tree", function() {
        ...
        describe("Parsing from alternative PGN source", function() {
            var aGame = "[Event	\"Golden Knights\"]" +
                    "[Site	\"correspondence\"]\n" +
                    "[Date	\"1993.?.?\"]\n" +
                    "[Round	\"15\"]\n" +
        ...
        describe("Reloading a new game into an existing player", function () {
            var goodPGN = "[Event \"Dayton\"]" +
                        "[Site \"?\"]\n" +
                        "[Date	\"1890.02.25\"]\n" +
                        "[Round	\"?\"]\n" +
            ...
            it(" Should reload a new player over the old", function () {
                ...
                this.movediv.innerHTML = goodPGN;
                this.game = new MarshallPGN.Game("game1", {"reload": true});
                expect(playerDiv.children.length).toBe(3);
            });
        });
	});
})();